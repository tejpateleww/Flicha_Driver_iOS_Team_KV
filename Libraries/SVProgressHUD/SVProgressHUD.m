...
- (instancetype)initWithFrame:(CGRect)frame{
    if((self = [super initWithFrame:frame])){
        ...
        _foregroundColor = [UIColor colorWithRed:255/255 green:116/255 blue:0/255 alpha:1.0];
        //UIColor.color(string: "ff7400")[UIColor blackColor];
        self.alpha = 0.0f;
        ...
        _ringThickness = 4;
        _ringRadius = 17;
        _ringNoTextRadius = 17;
        _cornerRadius = 14;
        _minimumDismissTimeInterval = 0.1f;
        _isInitializing = NO;
    }
    return self;
}
...
- (UIColor *)foregroundColorForStyle{
    if(self.defaultStyle == SVProgressHUDStyleLight){
        ...
        return [UIColor blackColor]; //[UIColor blackColor]; // [UIColor whiteColor];//[UIColor colorForColorString:@"2996d7"];
