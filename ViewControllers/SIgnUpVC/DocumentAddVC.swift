...
class DocumentAddVC: UIViewController , UIImagePickerControllerDelegate, UINavigationControllerDelegate, WWCalendarTimeSelectorProtocol {
...
//        lblDriverLicence.text = "Driver Licence (Front only)".localized
        ...
        lblDriverLicenceExpiryDate.text = "Select date".localized
...
//            }
    ...
    @IBAction func signupClick(_ sender: Any) {
        ...
        else if imgVehicleInsurance.image == UIImage(named: "iconPlaceholderVehicle") {
            
            UtilityClass.showAlert("App Name".localized, message: "Please enter all document\'s detail.".localized, vc: self)

        }
        else if imgVwProxy.image == UIImage(named: "iconPlaceholderVehicle") {
    ...
    func getAllRegistrationData()
    {
      ...
      /* Extra key remove
        ...
        let bankHolderName: String = userDefault.object(forKey: RegistrationFinalKeys.kbankHolderName) as! String
              dictData[RegistrationFinalKeys.kbankHolderName] = bankHolderName as AnyObject
        
        let bankBranch: String = userDefault.object(forKey: RegistrationFinalKeys.kBSB) as! String
              dictData[RegistrationFinalKeys.kBSB] = bankBranch as AnyObject
...
//
    ...
    func SetVehicleExpiryDates()
    {
        ...
        let DriverLicenceExpiryDate = lblDriverLicenceExpiryDate.text
...
//        let AccreditationCertificateExpiryDate = txtAccreditation.text
        ...
        let VehicleInsuranceCertificateExpiryDate = lblVehicleInsuranceExpiryDate.text
...
//        dictData[RegistrationFinalKeys.kAccreditationCertificateExpiryDate] = AccreditationCertificateExpiryDate as AnyObject
    ...
    @IBAction func btnProxyClick(_ sender: UIButton) {
        ...
        else
        {
            if imagePicked == 1 {
               ...
               /* imgAccreditationCertifi.image = pickedImage
                ...
                imgVehicleInsurance.image = pickedImage
                DispatchQueue.main.asyncAfter(deadline: .now() + 1.0) {
                    self.present(selector, animated: true, completion: nil)
                }
            }else if imagePicked == 5 {
                imgVwProxy.image = pickedImage
...
//            txtAccreditation.text = mySelectedDate as String
     ...
     func webserviceForRegistration(){
            ...
            webserviceForRegistrationForDriver(dictData as AnyObject, image1: imgDriverLicence.image!, image2: imgCarRegistration.image!, image3: imgVehicleInsurance.image!, image4: imgVwProxy.image!, image5: imgDriver, image6: imgVehicle) { (result, status) in
