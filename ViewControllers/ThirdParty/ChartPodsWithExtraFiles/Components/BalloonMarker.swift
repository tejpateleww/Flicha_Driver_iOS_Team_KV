...
public class BalloonMarker: MarkerImage {
    ...
    public override func draw(context: CGContext, point: CGPoint) {
        ...
        label.draw(in: rect, withAttributes: _drawAttributes as [NSAttributedString.Key : Any])
...
//        _drawAttributes[.foregroundColor] = self.textColor
        ...
        _labelSize = label?.size(withAttributes: _drawAttributes as [NSAttributedString.Key : Any]) ?? CGSize.zero
