...
open class WWCalendarTimeSelector: UIViewController, UITableViewDelegate, UITableViewDataSource, WWCalendarRowProtocol, WWClockProtocol {
    ...
    open override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(WWCalendarTimeSelector.didRotateOrNot), name: UIDevice.orientationDidChangeNotification, object: nil)//NSNotification.Name.
...
internal class WWClock: UIView {
    ...
    internal override func draw(_ rect: CGRect) {
        ...
        if showingHour {
            let textAttr : [NSAttributedString.Key : Any] = [NSAttributedString.Key(rawValue: NSAttributedString.Key.font.rawValue): fontHour, NSAttributedString.Key(rawValue: NSAttributedString.Key.foregroundColor.rawValue): fontColorHour, NSAttributedString.Key(rawValue: NSAttributedString.Key.paragraphStyle.rawValue): paragraph]
            let textAttrHighlight : [NSAttributedString.Key : Any] = [NSAttributedString.Key(rawValue: NSAttributedString.Key.font.rawValue): fontHourHighlight, NSAttributedString.Key(rawValue: NSAttributedString.Key.foregroundColor.rawValue): fontColorHourHighlight, NSAttributedString.Key(rawValue: NSAttributedString.Key.paragraphStyle.rawValue): paragraph]
            ...
            let textAttr : [NSAttributedString.Key : Any] = [NSAttributedString.Key(rawValue: NSAttributedString.Key.font.rawValue): fontMinute, NSAttributedString.Key.foregroundColor: fontColorMinute, NSAttributedString.Key.paragraphStyle: paragraph]
            let textAttrHighlight : [NSAttributedString.Key : Any] = [NSAttributedString.Key(rawValue: NSAttributedString.Key.font.rawValue): fontMinuteHighlight, NSAttributedString.Key.foregroundColor: fontColorMinuteHighlight, NSAttributedString.Key.paragraphStyle: paragraph]
